<template>
  <div>
    ...
    <div class="mb-6 flex justify-between items-center">
      ...
      <inertia-link class="btn-indigo" href="/organizations/new">
        <span>Create</span>
    ...
    <div class="bg-white rounded shadow overflow-x-auto">
      <table class="w-full whitespace-no-wrap">
        ...
        <tr v-for="organization in organizations.data" :key="organization.id" class="hover:bg-grey-lightest focus-within:bg-grey-lightest">
          <td class="border-t">
            <inertia-link class="px-6 py-4 flex items-center focus:text-indigo" :href="`/organizations/${organization.id}/edit`">
              {{ organization.name }}
  ...
  watch: {
    form: {
      handler: _.throttle(function() {
        ...
        this.$inertia.replace("/organizations") // need to account for query
      }, 150),
      deep: true,
    },
  },
